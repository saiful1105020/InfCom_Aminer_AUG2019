...
public class Author {
    ...
    public HashMap<Integer, CountPair> getKeywordCountsCopy() {
        return keywordCountsCopy;
    }

    public void setKeywordCountsCopy(HashMap<Integer, CountPair> keywordCountsCopy) {
        this.keywordCountsCopy = keywordCountsCopy;
    }

    public HashMap<Integer, Double> getKeywordScoreCopy() {
        return keywordScoreCopy;
    }

    public void setKeywordScoreCopy(HashMap<Integer, Double> keywordScoreCopy) {
        this.keywordScoreCopy = keywordScoreCopy;
    }
    ...
    public void retrieveKeywordMaps()
    {
        ...
        keywordScore.clear();
        //shallow copy is fine
        for(int keyId:keywordCountsCopy.keySet())
        {
            CountPair cp = keywordCountsCopy.get(keyId);
            double score = keywordScoreCopy.get(keyId);
            keywordCounts.put(keyId, cp);
            keywordScore.put(keyId, score);
        }
    }
